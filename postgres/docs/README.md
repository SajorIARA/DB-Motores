...
Para uso diario, consulta los archivos en la carpeta raíz `postgres/`:

1. **[README.md](../README.md)** - Documentación principal del proyecto
2. **[QUICK-START.md](../QUICK-START.md)** - Guía rápida de inicio
3. **[STRUCTURE.md](../STRUCTURE.md)** - Estructura y organización del proyecto
